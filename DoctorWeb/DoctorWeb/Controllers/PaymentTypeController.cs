...
namespace DoctorWeb.Controllers
{
    public class PaymentTypeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,PaymentTypeName,Rupees,IsSync")] PaymentType paymentType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,PaymentTypeName,Rupees,IsSync")] PaymentType paymentType)
        {
            if (ModelState.IsValid)
            {
