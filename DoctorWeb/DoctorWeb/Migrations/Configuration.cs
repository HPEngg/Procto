    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DoctorWeb.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(DoctorWeb.Models.ApplicationDbContext context)
        {
            ...
            context.Departments.AddOrUpdate(
                new Models.Department() { Name = "Department1"},
                new Models.Department() { Name = "Department2" },
                new Models.Department() { Name = "Department3" }
                );

            context.ReferredBy.AddOrUpdate(
                new Models.ReferredBy() { Name = "Doctor"},
                new Models.ReferredBy() { Name = "Patient" },
